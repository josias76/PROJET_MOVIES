# MovieLens SDK - `filmsjnm`
# **Construiction d'un Écosystème Data Centré sur le Cinéma avec Python, FastAPI et Streamlit** 
...
1. Clone le dépôt :
   ```bash
   git clone https://github.com/josias76/movies-backend.git
   cd movies-backend
